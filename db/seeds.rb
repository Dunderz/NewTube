...
v1 = Video.create!(title: "when u pass rails2", author_id: 1)
...
v7 = Video.create!(title: "when u get peter after being stuck on the overview", author_id: 3)
# v.video.attach(io: File.open("/mnt/c/Users/Isaac\ Nam/Desktop/newtubevids/omardance.mp4"), filename: "omardance.mp4")
v1.video.attach(io: open("https://newtube-dev.s3.amazonaws.com/omardance.mp4"), filename: "omardance.mp4")
...
v7.video.attach(io: open("https://newtube-dev.s3.amazonaws.com/starmanmariokart.mp4"), filename: "starmanmariokart.mp4")
