...
v2 = Video.create!(id: 2, title: "Mario Kart 8 - Dolphin Shoals - Music", author_id: 3, description: "Mario Kart 8 music composed by Shiho Fuiji / Atsuko Asahi / Ryo Nagamatsu / Yasuaki Iwata. Released 2014", views: 0)
v3 = Video.create!(id: 3, title: "TENET - Official Trailer", author_id: 5, description: "From Director Christopher Nolan. #TENET, coming to theaters 7.17.20. Watch the new trailer now.", views: 0)
v4 = Video.create!(id: 4, title: "French Bulldog Temper Tantrum", author_id: 7, description: "My dog is so cute!!!", views: 0)
v5 = Video.create!(id: 5, title: "when u pass rails 2", author_id: 2, description: "that test was mad hard lmao", views: 0)
...
v8 = Video.create!(id: 8, title: "Star Wars: The Rise of Skywalker (FULL MOVIE)", author_id: 8, description: "Star Wars: The Rise of Skywalker (also known as Star Wars: Episode IX – The Rise of Skywalker) is a 2019 American epic space opera film produced, co-written, and directed by J. J. Abrams. It is the third installment of the Star Wars sequel trilogy.", views: 0)
v9 = Video.create!(id: 9, title: "when u have 9 strikes and its 8:59", author_id: 1, description: "better hurry up", views: 0)
...
v11 = Video.create!(id: 11, title: "learning redux", author_id: 5, description: "literally impossible to learn", views: 0)
v12 = Video.create!(id: 12, title: "yamero", author_id: 2, description: "haha u clicked on this video", views: 0)
v13 = Video.create!(id: 13, title: "O(1) runtime", author_id: 1, description: "zoom zoom", views: 0)
v14 = Video.create!(id: 14, title: "when u think u finished app academy", author_id: 6, description: "Confusion 100", views: 0)
v15 = Video.create!(id: 15, title: "ouch", author_id: 8, description: ":(", views: 0)
v16 = Video.create!(id: 16, title: "Interstellar Movie - Official Trailer", author_id: 3, description: "The official Interstellar movie trailer from Christopher Nolan, starring Matthew McConaughey. http://www.InterstellarMovie.com/", views: 0)
v17 = Video.create!(id: 17, title: "ta after they tell you to look at the docs", author_id: 4, description: "sad noise", views: 0)
v18 = Video.create!(id: 18, title: "ur face when app academy became remote", author_id: 1, description: "stuck between a rock and a hard place", views: 0)
...
s1 = Subscription.create!(subscriber_id: 1, channel_id: 2)
s2 = Subscription.create!(subscriber_id: 1, channel_id: 3)
s3 = Subscription.create!(subscriber_id: 1, channel_id: 4)
s4 = Subscription.create!(subscriber_id: 1, channel_id: 5)
s5 = Subscription.create!(subscriber_id: 1, channel_id: 6)
s6 = Subscription.create!(subscriber_id: 1, channel_id: 7)
s7 = Subscription.create!(subscriber_id: 1, channel_id: 8)

s8 = Subscription.create!(subscriber_id: 2, channel_id: 1)
s9 = Subscription.create!(subscriber_id: 2, channel_id: 3)
s10 = Subscription.create!(subscriber_id: 2, channel_id: 4)
s11 = Subscription.create!(subscriber_id: 2, channel_id: 6)
s12 = Subscription.create!(subscriber_id: 2, channel_id: 7)
s13 = Subscription.create!(subscriber_id: 2, channel_id: 5)

s14 = Subscription.create!(subscriber_id: 3, channel_id: 8)
s15 = Subscription.create!(subscriber_id: 3, channel_id: 4)
s16 = Subscription.create!(subscriber_id: 3, channel_id: 2)
s17 = Subscription.create!(subscriber_id: 3, channel_id: 1)
s18 = Subscription.create!(subscriber_id: 3, channel_id: 5)

s19 = Subscription.create!(subscriber_id: 4, channel_id: 7)
s20 = Subscription.create!(subscriber_id: 4, channel_id: 6)
s21 = Subscription.create!(subscriber_id: 4, channel_id: 5)
s22 = Subscription.create!(subscriber_id: 4, channel_id: 1)

s23 = Subscription.create!(subscriber_id: 5, channel_id: 1)
s24 = Subscription.create!(subscriber_id: 5, channel_id: 3)
s25 = Subscription.create!(subscriber_id: 5, channel_id: 7)
s26 = Subscription.create!(subscriber_id: 5, channel_id: 8)
s27 = Subscription.create!(subscriber_id: 5, channel_id: 4)
s28 = Subscription.create!(subscriber_id: 5, channel_id: 2)

s29 = Subscription.create!(subscriber_id: 6, channel_id: 2)
s30 = Subscription.create!(subscriber_id: 6, channel_id: 3)
s31 = Subscription.create!(subscriber_id: 6, channel_id: 4)
s32 = Subscription.create!(subscriber_id: 6, channel_id: 1)
s33 = Subscription.create!(subscriber_id: 6, channel_id: 5)

s34 = Subscription.create!(subscriber_id: 7, channel_id: 1)
s35 = Subscription.create!(subscriber_id: 7, channel_id: 2)
s36 = Subscription.create!(subscriber_id: 7, channel_id: 3)
s37 = Subscription.create!(subscriber_id: 7, channel_id: 8)
s38 = Subscription.create!(subscriber_id: 7, channel_id: 6)
s39 = Subscription.create!(subscriber_id: 7, channel_id: 5)
s40 = Subscription.create!(subscriber_id: 7, channel_id: 4)

s41 = Subscription.create!(subscriber_id: 8, channel_id: 1)
s42 = Subscription.create!(subscriber_id: 8, channel_id: 5)
s43 = Subscription.create!(subscriber_id: 8, channel_id: 2)

l1 = Like.create!(likable_id: 1, likable_type: "Video", user_id: 1, value: "like")
l2 = Like.create!(likable_id: 1, likable_type: "Video", user_id: 2, value: "like")
l3 = Like.create!(likable_id: 1, likable_type: "Video", user_id: 4, value: "like")
l4 = Like.create!(likable_id: 1, likable_type: "Video", user_id: 5, value: "like")
l5 = Like.create!(likable_id: 1, likable_type: "Video", user_id: 3, value: "dislike")
